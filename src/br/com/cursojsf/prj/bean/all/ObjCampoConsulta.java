...
public class ObjCampoConsulta implements Serializable, Comparator<ObjCampoConsulta>{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ObjCampoConsulta other = (ObjCampoConsulta) obj;
		if (campoBanco == null) {
	...
	@Override
	public int compare(ObjCampoConsulta o1, ObjCampoConsulta o2) {
		// TODO Auto-generated method stub
		return ((ObjCampoConsulta)o1).getPrincipal().compareTo(((ObjCampoConsulta)o2).getPrincipal());
	}
